...
export interface ExpectTestCaseParams {
    ...
    expectedAbsoluteMargin?: BigNumber | string | number,
...
export interface OpenMarketWithDepositAmountParam {
...
export interface OpenMarketPositionParam {
    positionManager: string,
    trader: string,
    side: BigNumberish,
    ...
    busdBonusAmount: BigNumberish
}

export interface OpenLimitWithDepositAmountParam {
    positionManager: string,
    trader: SignerWithAddress,
    side: number,
    quantity: BigNumber,
...
export interface OpenLimitOrderParam {
    positionManager: string,
    trader: string,
    side: BigNumberish,
    quantity: BigNumberish,
...
export interface CloseMarketOrderParam {
    positionManager: string,
    quantity: BigNumberish,
    trader: SignerWithAddress
}

export interface CloseLimitOrderParam {
    positionManager: string,
    pip: BigNumberish,
    quantity: BigNumberish,
    trader: SignerWithAddress
