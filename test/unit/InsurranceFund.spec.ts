...
import {AccessController, BEP20Mintable, InsuranceFundTest, PositionManager} from "../../typeChain";
...
describe('Insurance Fund', async function () {
    ...
    beforeEach(async () => {
        ...
        await positionManager.initialize(BigNumber.from(200), busdToken.address, ethers.utils.formatBytes32String('BTC'), BigNumber.from(100), BigNumber.from(10000), BigNumber.from(10000), BigNumber.from(3000), BigNumber.from(1000), '0x5741306c21795FdCBb9b265Ea0255F499DFe515C'.toLowerCase());
        ...
        await insuranceFund.initialize(accessController.address);
