...
contract PositionHouseCoinMargin is PositionHouseBase {
    ...
    //    }
    //
    //    // TODO: move to market maker gateway
    ////    function supply(
    ////        IPositionManager _positionManager,
    ...
    //    internal override
    //    {
    //        PositionManagerAdapter.deposit(IPositionManager(positionManager), trader, amount, fee);
    //    }
    //
    //    function _withdraw(
    //        address positionManager,
    ...
    //    ) internal override
    //    {
    //        PositionManagerAdapter.withdraw(IPositionManager(positionManager), trader, amount);
    //    }
    //
