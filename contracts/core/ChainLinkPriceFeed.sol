...
contract ChainLinkPriceFeed is OwnableUpgradeable, IChainLinkPriceFeed {
    ...
    mapping(address => bool) private validatedContributor;
    mapping(bytes32 => uint256) private indexPriceFeedMap;
    mapping(bytes32 => uint256) private twapPriceFeedMap;

    modifier onlyContributor() {
        require(isValidatedContributor(_msgSender()), "only contributor");
        _;
    }
