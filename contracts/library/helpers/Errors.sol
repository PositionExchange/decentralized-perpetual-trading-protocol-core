...
library Errors {
    ...
    string public constant VL_PASS_ALL = "0";
    ...
    string public constant VL_INITIAL_MARGIN = "10"; // 'IM'
    ...
    // deprecated: string public constant VL_LONG_PRICE_THAN_CURRENT_PRICE = "16"; // '!B'
    // deprecated: string public constant VL_SHORT_PRICE_LESS_CURRENT_PRICE = "17"; // '!S'
